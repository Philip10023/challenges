...
twitter_data.each do |hash|
  hash.each do |twitter_acc, v|
    if v.values.first == nil
      puts "N/A"
    else
  puts "#{hash.keys.first}: #{v.values.first}"
end
end
end
print "-----------------------\n"
twitter_data.each do |hash|
 hash.each do |twitter_acc, v|
   puts "#{hash.keys.first}: #{v.values[5]}"
 end
 end
 print "---------------------\n"
 twitter_data.each do |hash|
  hash.each do |twitter_acc, v|
    puts "#{hash.keys.first}'s latest tweet was #{v.values[4].size} charecters long."
  end
  end
  print "-----------------------\n"
twitter_data.each do |hash|
  hash.each do |twitter_acc, v|
    puts "#{hash.keys.first}'s account used #{v.values[1].join.size} charecters in the last twenty tweets"
  end
end
print "----------------------\n"
followers = Array.new
twitter_data.each do |hash|
  hash.each do |twitter_acc, v|
  followers << v.values[2]

if v.values[2] == followers.max
end
end
end
friends = Array.new
twitter_data.each do |hash|
  hash.each do |twitter_ac, k|
  friends << k.values[3]
  if k.values[3] == friends.max
end
end
end
tweets = Array.new
twitter_data.each do |hash|
  hash.each do |twitter_acc, v|
    tweets << v.values[5]
    puts "#{twitter_acc}\n--------------" if v.values[5] == tweets.max
end
end
twitter_data.each do |hash|
  hash.each do |twitter_acc, v|
  puts twitter_acc if v.values[0] != nil
end
end
print "-----------\n"
twitter_data.each do |hash|
  hash.each do |twitter_acc, v|
  puts twitter_acc if v.values.last != nil
end
end
