...
print "-------------------\n"
sum = 0
people["Brian Heller"]["children"].each do |children|
sum += 1
end
puts sum
print "------------------\n"
...
print "------------------\n"
puts people["Dr. Adela DuBuque"]["children"] = "Tomas DuBuque"
print "------------------\n"
...
sum = 0
sets_of_people[0].each do |people, n|
  sum += 1
end
puts sum
print "-----------------\n"
sum = 0
sets_of_people[1].each do |people, n|
  sum += 1
end
puts sum
print "-----------------\n"
...
print "---------------\n"
sets_of_people[0].each do |person, key|
  if key["company"].include?"m"
    puts person
end
end
print "-----------------\n"
