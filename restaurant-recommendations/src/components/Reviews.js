...
const NewReview = (props) => (
  <div className="row mbl">
    <div className="small-1 columns"><strong>Name</strong></div>
    <div className="small-11 columns">{props.name}</div>

    <div className="small-1 columns"><strong>Score</strong></div>
    <div className="small-11 columns">{props.rating} stars</div>

    <div className="small-1 columns"><strong>Review</strong></div>
    <div className="small-11 columns">{props.content}</div>
  </div>
)
...
const Reviews = (props) => {
  ...
  <div>
  {reviews}
  <ReviewForm newReviewHandler={props.newReviewHandler}/>
  </div>
)
}
